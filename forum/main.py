...
class Install(webapp.RequestHandler, AclUser, DataBaseOperations):
  ...
  def get(self):
    ...
    path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'manageForum.html'))
...
class AddTopic(webapp.RequestHandler, AclUser, DataBaseOperations):
  ...
  def get(self):
    ...
    path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'addTopic.html'))
    self.response.out.write(template.render(path, template_values))
...
class ViewTopic(webapp.RequestHandler, AclUser, DataBaseOperations):
  ...
  def get(self):
    ...
    path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'viewTopic.html'))
    self.response.out.write(template.render(path, template_values))    
  ...
  def get(self):
    ...
    try:
      if self.checkMode(str(self.request.get('mode'))):
        ...
        path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'viewForumAdminMode.html'))
        self.response.out.write(template.render(path, template_values))
        return
    except:
      pass
    path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'viewForum.html'))
    self.response.out.write(template.render(path, template_values))
...
class ModifyThread(webapp.RequestHandler, AclUser):
  ...
  def get(self):
    ...
    path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'modifyThread.html'))
    self.response.out.write(template.render(path, template_values))
...
class ViewThread(webapp.RequestHandler, AclUser, DataBaseOperations):
  ...
  def get(self):
    ...
    try:
      if self.checkMode(str(self.request.get('mode'))):
        #self.response.headers.add_header('Set-Cookie', 'mode=%s; expires=Fri, 31-Dec-2020 23:59:59 GMT' % 'admin')
        path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'viewThreadAdminMode.html'))
        self.response.out.write(template.render(path, template_values))
        return
    except:
      pass
    path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'viewThread.html'))
    self.response.out.write(template.render(path, template_values))
...
class Profile(webapp.RequestHandler, AclUser, DataBaseOperations):
  ...
  def get(self):
    ...
    path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'myProfile.html'))
    self.response.out.write(template.render(path, template_values))
  ...
  def get(self):   
    if self.request.get('user'):
      try:
        ...
        path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'viewProfile.html'))
        self.response.out.write(template.render(path, template_values))  
      except:
        return
    else:
...
class ViewAllUsers(webapp.RequestHandler, AclUser, DataBaseOperations):
  ...
  def get(self):
    ...
    #for user in self.getUsers().order('-login'):
      #print user.login
    path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'viewUsers.html'))
    self.response.out.write(template.render(path, template_values))
...
class PrivateMessage(webapp.RequestHandler, AclUser, DataBaseOperations):
  ...
  def get(self):
    ...
    path = os.path.join(os.path.dirname(__file__), os.path.join('templates', 'privateMessageForm.html'))
    self.response.out.write(template.render(path, template_values))
