 ...
 * </p>
 */
public class PlusAssignmentExpression extends BinaryExpression {

    private static final long serialVersionUID = 2231703242365649114L;
     ...
     */
    public PlusAssignmentExpression(Expression lhs, Expression rhs) {
        super(lhs, rhs, "+=");
    }
